...
export const basePath = 'theory'

export async function getAllPosts(): Promise<CollectionEntry<'theory'>[]> {
...
export async function getAllPostsByCategory(category: string): Promise<CollectionEntry<'theory'>[]> {
  const posts = await getCollection('theory')
  return posts
...
export async function getPostById(
  postId: string,
): Promise<CollectionEntry<'theory'> | null> {
...
): Promise<CollectionEntry<'theory'>[]> {
...
export async function getAdjacentPosts(currentId: string): Promise<{
  newer: CollectionEntry<'theory'> | null
  older: CollectionEntry<'theory'> | null
  parent: CollectionEntry<'theory'> | null
}> {
...
export function groupPostsByYear(
  posts: CollectionEntry<'theory'>[],
): Record<string, CollectionEntry<'theory'>[]> {
  return posts.reduce(
    (acc: Record<string, CollectionEntry<'theory'>[]>, post) => {
